...
def newplot(title="Yeast fedbatch cultivation", plotType="TimeSeries"):
    ...
    if plotType in ["Overview"]:
        ...
        diagrams.append(
            "ax[2].plot(t,sim_res['bioreactor.c[3]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[4].plot(t,sim_res['bioreactor.c[1]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(t,sim_res['DOsensor.out'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(t,sim_res['DO_setpoint.out'],color='y',linestyle='--')"
        )
        diagrams.append(
            "ax[8].step(t,sim_res['bioreactor.N'],color='c',linestyle=linetype)"
        )
        diagrams.append("ax[8].set_ylim([0,1700])")
        diagrams.append(
            "ax[10].plot(t,sim_res['bioreactor.inlet[1].F'],color='c',linestyle=linetype)"
        )
        diagrams.append(
            "ax[12].plot(t,sim_res['bioreactor.V'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[12].plot(t,sim_res['bioreactor.V_tot'],color='y', linestyle='--')"
        )
        diagrams.append("ax[12].set_ylim([0, 9.0])")

        diagrams.append(
            "ax[1].plot(t,sim_res['bioreactor.culture.qGm'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[1].plot(t,sim_res['bioreactor.culture.qGr'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(t,-sim_res['bioreactor.culture.qEm'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(t,sim_res['bioreactor.culture.qEr'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(t,sim_res['bioreactor.culture.q[1]'],color='b',linestyle=linetype)"
        )

        diagrams.append(
            "ax[7].plot(t,sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[9].plot(t,sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[11].plot(t,sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.Qspec'],color='b',linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(t,sim_res['DOsensor.out'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[0].plot(t,sim_res['DO_setpoint.out'],color='r',linestyle='--')"
        )
        diagrams.append(
            "ax[1].step(t,sim_res['bioreactor.N'],color='b',linestyle=linetype)"
        )
        diagrams.append("ax[1].set_ylim([0,2500])")
        diagrams.append(
            "ax[2].plot(t,sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(t,sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)"
        )
...
def eigValReactor(model):
    ...
    A, B, C, D = model.get_state_space_representation(
        A=True, B=False, C=False, D=False, use_structure_info=False
    )
