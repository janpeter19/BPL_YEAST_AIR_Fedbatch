...
# 2026-09-22 - Change indentaiton from 3 spaces to 4 using black
# ------------------------------------------------------------------------------------------------------------------
...
def newplot(title="Yeast fedbatch cultivation", plotType="TimeSeries"):
    ...
    if plotType in ["Overview"]:
        ...
        ax11 = plt.subplot(7, 2, 1)
        ax12 = plt.subplot(7, 2, 2)
        ax21 = plt.subplot(7, 2, 3)
        ax22 = plt.subplot(7, 2, 4)
        ax31 = plt.subplot(7, 2, 5)
        ax32 = plt.subplot(7, 2, 6)
        ax41 = plt.subplot(7, 2, 7)
        ax42 = plt.subplot(7, 2, 8)
        ax51 = plt.subplot(7, 2, 9)
        ax52 = plt.subplot(7, 2, 10)
        ax61 = plt.subplot(7, 2, 11)
        ax62 = plt.subplot(7, 2, 12)
        ...
        diagrams.append(
            "ax[2].plot(sim_res['time'],sim_res['bioreactor.c[3]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[4].plot(sim_res['time'],sim_res['bioreactor.c[1]'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(sim_res['time'],sim_res['DOsensor.out'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(sim_res['time'],sim_res['DO_setpoint.out'],color='y',linestyle='--')"
        )
        diagrams.append(
            "ax[8].step(sim_res['time'],sim_res['bioreactor.N'],color='c',linestyle=linetype)"
        )
        diagrams.append("ax[8].set_ylim([0,1700])")
        diagrams.append(
            "ax[10].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'],color='c',linestyle=linetype)"
        )
        diagrams.append(
            "ax[12].plot(sim_res['time'],sim_res['bioreactor.V'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[12].plot(sim_res['time'],sim_res['bioreactor.V_tot'],color='y', linestyle='--')"
        )
        diagrams.append("ax[12].set_ylim([0, 9.0])")

        diagrams.append(
            "ax[1].plot(sim_res['time'],sim_res['bioreactor.culture.qGm'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[1].plot(sim_res['time'],sim_res['bioreactor.culture.qGr'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(sim_res['time'],-sim_res['bioreactor.culture.qEm'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(sim_res['time'],sim_res['bioreactor.culture.qEr'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(sim_res['time'],sim_res['bioreactor.culture.q[1]'],color='b',linestyle=linetype)"
        )

        diagrams.append(
            "ax[7].plot(sim_res['time'],sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[9].plot(sim_res['time'],sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[11].plot(sim_res['time'],sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.Qspec'],color='b',linestyle=linetype)"
        )
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(sim_res['time'],sim_res['DOsensor.out'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[0].plot(sim_res['time'],sim_res['DO_setpoint.out'],color='r',linestyle='--')"
        )
        diagrams.append(
            "ax[1].step(sim_res['time'],sim_res['bioreactor.N'],color='b',linestyle=linetype)"
        )
        diagrams.append("ax[1].set_ylim([0,2500])")
        diagrams.append(
            "ax[2].plot(sim_res['time'],sim_res['bioreactor.m[1]']*sim_res['bioreactor.culture.qO2'],color='b',linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'],color='b',linestyle=linetype)"
        )
...
def describe(name, decimals=3):
    ...
    if name == "culture":
        ...
        print(
            CO2_description, "index     = ", CO2, "- molecular weight = ", CO2_mw, "Da"
        )
        print(E_description, "index = ", E, "- molecular weight = ", E_mw, "Da")
